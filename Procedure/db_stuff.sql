...
CREATE OR ALTER PROCEDURE [dbo].[sp_GetEmpsPlusDept]
AS
...
SELECT
    EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, COMM, cteReports.DEPTNO, DEPT.DNAME
FROM cteReports 
	INNER JOIN DEPT ON cteReports.DEPTNO = DEPT.DEPTNO
GO
